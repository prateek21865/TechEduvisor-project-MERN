  ...
  return (
      ...
      <div className="flex items-center">
        <div className="text-white font-bold">
          ...
          <span className="flex items-center gap-3">
            <img src="" alt="logo_img" className="h-[60px] w-[60px] rounded-full"/>
        ...
        <nav className="text-white px-10 max-lg:hidden">
            <ul className="flex items-center">
                <li className="mx-5 hover:border-b-2 hover:border-[#277db0]">Academic Preparation</li>
                <li className="mx-5 hover:border-b-2 hover:border-[#277db0]">Academic Mentorship Program</li>
                <li className="mx-5 hover:border-b-2 hover:border-[#277db0]">SoftSkills Courses</li>
                <li className="mx-5 hover:border-b-2 hover:border-[#277db0]">Study Abroad Program</li>
                <li className="mx-5 hover:border-b-2 hover:border-[#277db0]">MicroLearning</li>
            </ul>
        </nav>
      </div>
    ...
    openMenu && <div className="bg-[#0e2d42] px-[100px] h-auto ">
        <div className="text-white">
            <ul className="">
                <li className="py-2">Academic Preparation</li>
                <li className="py-2">Academic Mentorship Program</li>
                <li className="py-2">SoftSkills Courses</li>
                <li className="py-2">Study Abroad Program</li>
                <li className="py-2">MicroLearning</li>
            </ul>
        </div>
