      ...
      >
        ...
        {subject === "" && (
          <div className="flex flex-wrap gap-4 justify-center pt-2">
            {lessons.map((lesson) => {
              if (lesson.class === 9) return <LessonDetail lesson={lesson} />;
            })}
          </div>
        )}
        ...
        {subject === "Science" && (
          <div className="flex flex-wrap gap-4 justify-center pt-2">
            {lessons.map((lesson) => {
              if (lesson.class === 9 && lesson.subject === "Science")
        ...
        {subject === "Mathematics" && (
          <div className="flex flex-wrap gap-4 justify-center pt-2">
            {lessons.map((lesson) => {
              if (lesson.class === 9 && lesson.subject === "Mathematics")
                return <LessonDetail lesson={lesson} />;
            })}
          </div>
        )}
