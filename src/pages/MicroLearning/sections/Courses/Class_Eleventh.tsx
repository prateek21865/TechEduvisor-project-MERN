      ...
      >
        ...
        {subject === "" && (
          <div className="flex flex-wrap gap-4 justify-center pt-2">
            {lessons.map((lesson) => {
              if (lesson.class === 11) return <LessonDetail lesson={lesson} />;
            })}
          </div>
        )}
        ...
        {subject === "Physics" && (
          <div className="flex flex-wrap gap-4 justify-center pt-2">
            {lessons.map((lesson) => {
              if (lesson.class === 11 && lesson.subject === "Physics")
        ...
        {subject === "Chemistry" && (
          <div className="flex flex-wrap gap-4 justify-center pt-2">
            {lessons.map((lesson) => {
              if (lesson.class === 11 && lesson.subject === "Chemistry")
                return <LessonDetail lesson={lesson} />;
            })}
          </div>
        )}
        ...
        {subject === "Mathematics" && (
          <div className="flex flex-wrap gap-4 justify-center pt-2">
            {lessons.map((lesson) => {
              if (lesson.class === 11 && lesson.subject === "Mathematics")
                return <LessonDetail lesson={lesson} />;
            })}
          </div>
        )}
