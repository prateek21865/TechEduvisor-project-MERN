...
const HomePage = () => {
  return (
    <>
        ...
        <div className='flex w-full h-[260px] items-center justify-center pt-2 pb-4 bg-[#0e2d42] relative'>
          <img src={FirstImg} alt="first image" className='absolute h-[250px] bottom-0 left-[100px] max-lg:hidden'/>
            <div className='flex flex-col items-center'>
              ...
              <h3 className='text-white text-[25px] pt-2'>IIT JEE + CBSE</h3>
              <p className='text-yellow-400 text-[15px] pt-2' >Learn from Experience Instructors</p>
              <div className='bg-[#277db0] text-white p-2 rounded-lg mt-2 hover:opacity-70'><Link to='/'>Explore More</Link></div>
            </div>
        </div>
      </section>
      ...
      <div className='bg-red-500 h-[50px]'> More sections can be added </div>
    </main>
    <footer>
        <Footer />
    </footer>
